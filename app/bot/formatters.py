...
def format_help_message() -> str:
    return (
        "🤖 <b>PERSONAL AI OS — HELP & COMMANDS</b>\n\n"
        "<b>Productivity Commands:</b>\n"
        "/tasks — Show today's active tasks & inline buttons\n"
        "/today — Show today's full productivity status\n"
        "/progress — View today's score and completion %\n"
        "/streak — View current streak, longest streak, and stats\n"
        "/complete [task_name] — Mark a task as completed\n"
        "/skip [task_name] — Mark a task as skipped\n"
        "/remarks &lt;text&gt; — Add end-of-day remarks\n"
        "/addtask — Add a custom productivity task\n"
        "/removetask — Remove an existing task\n"
        "/edittask — Modify task targets or points\n\n"
        "<b>News Intelligence Commands:</b>\n"
        "/news — Full 25-item daily intelligence digest\n"
        "/news 5 — Compact top 5 news digest\n"
        "/ai — 5 verified AI & ML developments\n"
        "/world — 5 Geography & World developments\n"
        "/anime — 5 verified Anime announcements\n"
        "/telugu — 5 Andhra Pradesh & Telangana developments\n"
        "/india — 5 Indian national developments\n"
        "/sources — List all news sources & quality tiers\n\n"
        "<b>Schedule & Settings:</b>\n"
        "/times — View all configured reminder times\n"
        "/settime &lt;type&gt; &lt;HH:MM&gt; — Change reminder time\n"
        "/setnewstime &lt;HH:MM&gt; — Change news delivery time\n"
        "/timezone &lt;Zone&gt; — Change timezone (e.g. Asia/Kolkata)\n"
        "/settings — Interactive settings panel\n"
        "/status — Bot and system health\n"
    )
