...
def format_help_message() -> str:
    return (
        ...
        "<b>📊 Google Sheets Intelligence:</b>\n"
        "• <code>/sheet</code> — Interactive Sheet dashboard & summary\n"
        "• <code>sheet &lt;query&gt;</code> — Ask any natural language question over Sheet data\n\n"
